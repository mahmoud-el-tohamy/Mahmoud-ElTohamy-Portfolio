        ...
        >
          ...
          <div className="tablet:m-10 mt-5 flex flex-col laptop:flex-row items-center justify-between gap-20">
              ...
              <div className="flex flex-col gap-6 text-black/80 dark:text-gray-300">
                ...
                <div className="mt-4 flex flex-wrap gap-3">
                  {[
                    ...
                    <span
                      key={index}
                      className={`px-4 py-2 flex items-center gap-2 text-sm tablet:text-base font-medium rounded-full border shadow-sm hover:scale-105 transition-transform duration-300 cursor-default ${badge.color}`}
                    >
                      {badge.icon}
                      {badge.text}
                    </span>
            ...
            <div className="hidden laptop:flex w-full laptop:w-2/5 justify-center relative items-center h-full">
              ...
              <div
                className="w-32 h-32 bg-gradient-to-tl from-blue-500/80 to-[#004aad]/80 rounded-full shadow-xl animate-float backdrop-blur-md border border-white/20 absolute -bottom-5 -left-5"
